...
## Summary
Admin manages services, durations, required inputs, base pricing, eligibility.
...
## Entry points
catalog CRUD, fulfillment support, service metadata
...
## Business rules
Catalog changes version safely and do not break existing bookings.
