# Feature: Pricing Rules Management
...
## Summary
Admin manages base rates, fees, market multipliers, discounts, overrides.
...
## Entry points
pricing rules, effective dates, audit
...
## Business rules
Pricing is versioned, testable, auditable, and explains customer-visible totals.
