...
## Summary
System sends booking, provider, ETA, payment, report, and support notifications.

## Status
Designed. Current prototype may only implement part of this feature.

## Roles
System/Customer/Provider/Admin
...
## Business rules
Notifications are event-driven and avoid leaking sensitive data.
