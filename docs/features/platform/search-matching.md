...
## Summary
System matches providers to service, vehicle, location, slot, price, rating.

## Status
Designed. Current prototype may only implement part of this feature.

## Roles
System/Customer/Dispatcher
...
## Entry points
eligibility, ranking, filters, unavailable reasons
...
## Business rules
Ranking is deterministic and unsupported options are hidden/disabled with reasons.
