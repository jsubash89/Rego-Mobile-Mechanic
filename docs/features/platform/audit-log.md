...
## Summary
Platform records key state, payment, admin, support, provider actions.
...
## Entry points
events, actor, timestamp, diff, reason
...
## Business rules
Audit log is immutable enough for operational dispute resolution.
