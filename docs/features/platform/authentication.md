...
## Summary
Users sign in and receive role-based access.

## Status
Designed. Current prototype may only implement part of this feature.

## Roles
Customer/Provider/Admin/Support
...
## Entry points
guest, customer, provider, dispatcher, admin roles
...
## Business rules
Server-side authorization protects all role-scoped data.
