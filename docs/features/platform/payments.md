...
## Summary
Payment intents, captures, refunds, invoices, and provider payout linkage.

## Status
Designed. Current prototype may only implement part of this feature.

## Roles
Customer/System/Admin/Provider
...
## Entry points
authorization, capture, refund, webhooks, invoice
...
## Business rules
Payment actions are idempotent and reconciled through webhooks.
