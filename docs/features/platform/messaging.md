...
## Summary
Customer/provider/dispatcher/support communicate in booking context.
...
## Entry points
threads, attachments, templates, audit
...
## Business rules
Messages are scoped to booking/job and preserve privacy.
