...
## Summary
Customers review completed services and ratings affect providers.
...
## Entry points
review submission, moderation, aggregation
...
## Business rules
Only completed services can be reviewed; moderation/audit exists.
