...
## Summary
Provider-submitted report visible to customer after service.
...
## Entry points
work performed, notes, photos, parts, recommendations, warranty
...
## Business rules
Required report fields gate job closure; customer can access from history.
