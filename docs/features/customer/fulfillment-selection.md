...
## Summary
Customer chooses mobile mechanic, independent shop, or dealership fulfillment.
...
## Entry points
fulfillment cards, fees, eligibility, operational implications
...
## Business rules
Fulfillment filters providers and changes fees; unsupported service/location options are disabled with reasons.
