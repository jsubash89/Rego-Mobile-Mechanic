# Feature: Customer Service History
...
## Summary
Customer reviews vehicle service records and invoices.
...
## Entry points
history list, details, invoice, warranty, recommendations
...
## Business rules
Completed service creates record; report/payment/dispute states are separate.
