...
## Summary
Customer confirms appointment and receives durable booking/status.
...
## Entry points
confirmation CTA, idempotency, booking ID, pending provider confirmation
...
## Business rules
Duplicate clicks are safe; confirmation creates durable booking and status timeline.
