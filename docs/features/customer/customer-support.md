...
## Summary
Customer opens support/dispute/refund requests tied to booking/history.
...
## Entry points
ticket, categories, messages, refund/credit, escalation
...
## Business rules
Support tickets link to booking and require resolution category.
