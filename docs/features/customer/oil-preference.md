...
## Summary
Oil-change-specific oil/parts preference step.
...
## Entry points
mechanic recommendation, 5W-30, 0W-20, customer-provided oil
...
## Business rules
Visible only for oil-change; recommendation can produce TBD parts until provider confirms.
