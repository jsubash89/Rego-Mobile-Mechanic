...
## Summary
Customer compares eligible mechanics, shops, and dealerships.
...
## Entry points
provider cards, ratings, reviews, specialties, distance, availability
...
## Business rules
Selected provider updates summary; providers must be eligible for service/vehicle/fulfillment/location/slot.
