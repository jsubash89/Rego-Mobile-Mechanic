...
## Summary
Customer authorizes payment according to booking policy.
...
## Entry points
payment method, authorization, capture, failure, refunds
...
## Business rules
Payment timing is explicit; no sensitive payment data is logged or stored by app.
