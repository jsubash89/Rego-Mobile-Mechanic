...
## Summary
Mechanics, shops, and dealerships apply and become approved providers.
...
## Entry points
identity, business, certifications, insurance, service area, payout
...
## Business rules
Only approved providers appear in customer marketplace.
