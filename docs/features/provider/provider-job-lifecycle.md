# Feature: Provider Job Lifecycle
...
## Summary
Provider moves accepted job through en route, arrived, started, completed.

## Status
Designed. Current prototype may only implement part of this feature.

## Roles
Provider/Customer/Dispatcher
...
## Entry points
status transitions, ETA, blocks, approvals
...
## Business rules
Invalid transitions are blocked; customer notifications fire for meaningful changes.
