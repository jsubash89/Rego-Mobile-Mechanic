...
## Summary
Public/internal provider profile and trust data.
...
## Entry points
ratings, specialties, service area, credentials, photos, rates
...
## Business rules
PII/internal compliance data is not exposed publicly.
