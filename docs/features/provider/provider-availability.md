...
## Summary
Provider manages calendar, capacity, working hours, and travel buffers.
...
## Entry points
availability slots, blocks, service areas, capacity
...
## Business rules
Availability drives customer bookable slots and prevents double booking.
