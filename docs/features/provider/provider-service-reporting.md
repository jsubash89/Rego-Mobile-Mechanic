# Feature: Provider Service Reporting
...
## Summary
Provider documents work and submits report/photos/invoice details.
...
## Entry points
checklist, photos, notes, parts, recommendations
...
## Business rules
Report completeness gates job closure and creates customer service record.
