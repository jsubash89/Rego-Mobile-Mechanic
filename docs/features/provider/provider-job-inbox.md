...
## Summary
Provider sees offered/assigned jobs and takes action.
...
## Entry points
job offers, assigned jobs, accept/decline, SLA timers
...
## Business rules
Provider sees enough detail to accept/decline and cannot see unrelated jobs.
