...
## Summary
Dispatcher/system assigns or reassigns providers to bookings/jobs.
...
## Entry points
eligibility, assignment, reassignment, audit
...
## Business rules
Assignments respect provider capability, availability, service area, and state rules.
