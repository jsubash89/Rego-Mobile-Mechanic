...
## Summary
Dispatcher monitors active jobs, SLAs, assignments, and exceptions.
...
## Entry points
job queue, filters, SLA risk, margin placeholder
...
## Business rules
At-risk/unassigned jobs are visible and actionable.
