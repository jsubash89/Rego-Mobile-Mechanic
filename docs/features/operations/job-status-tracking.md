...
## Summary
Internal/customer/provider status timeline for booking/job lifecycle.
...
## Business rules
Every transition records actor, timestamp, reason, old/new state.
