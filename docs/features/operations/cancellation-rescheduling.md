# Feature: Cancellation and Rescheduling
...
## Summary
Actors cancel or reschedule bookings/jobs under policy.

## Status
Designed. Current prototype may only implement part of this feature.

## Roles
Customer/Provider/Dispatcher/Support
...
## Entry points
policy windows, fees, refunds, reassignment
...
## Business rules
Cancellation/reschedule is stateful, auditable, and policy-driven.
