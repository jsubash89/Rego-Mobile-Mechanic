...
4. `plans/autonomous-build-loop.md` — near-production MVP destination, phase gates, and reset/token-limit protocol.
5. `features/README.md` — feature-document index and ownership map.
6. `architecture/state-machines.md` — canonical booking/job lifecycle.
7. `quality/test-strategy.md` — exhaustive testing and release gates.
8. `plans/mobile-mechanic-build-plan.md` — implementation sequence.
