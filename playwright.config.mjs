...
export default defineConfig({
  ...
  webServer: {
    ...
    env: {
      ...
      OPERATOR_SHARED_SECRET: "operator-e2e-shared-secret-000000000000",
      OPERATOR_SESSION_SECRET: "operator-e2e-session-signing-secret-00000000",
      OPERATOR_RATE_LIMIT_SECRET: "operator-e2e-rate-hmac-secret-0000000000",
      OPERATOR_CANONICAL_ORIGIN: "http://127.0.0.1:3107",
    },
